...
for (ksite in 1:nsites){ ### Loop on sites or repeats 
  ...
  estim_path = "/home/frederic/Documents/MAR_modelling/resubmission/MAR_foodWeb/Gompertz_foodWeb/MAR_estimation/"
  # B matrix
  ...
  simul_path = "/home/frederic/Documents/MAR_modelling/resubmission/MAR_foodWeb/Gompertz_foodWeb/Gompertz_simulation/"
  # alpha matrix
...
pdf(file="unknownTopology/AcrossRepeats_BvsJ.pdf",width=12,height=15)
par(mfrow=c(5,4))
