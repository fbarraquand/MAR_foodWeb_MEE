...
element_vec=c("b_1,1","b_1,2","b_1,3","b_2,1","b_2,2","b_2,8", "b_3,1","b_3,3","b_3,5","b_3,6","b_4,4","b_4,5","b_4,6","b_4,7",
              ...
              "b_7,4","b_7,7","b_7,12","b_8,2","b_8,8","b_8,12","b_9,5","b_9,9","b_9,10","b_10,5","b_10,9","b_10,10",
...
within_repeats_correlation_metrics=round(within_repeats_correlation_metrics,digits=4)
