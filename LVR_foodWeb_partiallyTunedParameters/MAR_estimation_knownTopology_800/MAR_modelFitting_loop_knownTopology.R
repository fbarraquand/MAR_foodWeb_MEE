...
DBall=read.csv("/home/frederic/Documents/MAR_modelling/resubmission/MAR_foodWeb/LVR_foodWeb_partiallyTunedParameters/LVR_simulation_800/DataFoodWeb_wTime_abs.csv") 
head(DBall)
nrow(DBall)
